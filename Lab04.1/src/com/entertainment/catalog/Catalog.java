...
public class Catalog {
  ...
  public static Collection<Television> findByBrand(String brand) {
    Collection<Television> result = new ArrayList<>(); //a new collection to return with matching tvs
    for(Television tv : catalog){ // for every television in catalog
  ...
  public static Map<String,Collection<Television>> findByBrands(String... brands) {
    ...
    for (String brand : brands) {
        Collection<Television> temp = findByBrand(brand);
        if(!temp.isEmpty()) {
